...
function init() {
  ...
  mainWorkspace = Blockly.inject('blocky',
      {collapse: false,
       toolbox: toolbox,
       media: '../../media/'});
  ...
  if ('BlocklyStorage' in window && window.location.hash.length > 1) {
    ...
    var xml = '<xml xmlns="https://developers.google.com/blocky/xml"><block type="factory_base" deletable="false" movable="false"></block></xml>';
