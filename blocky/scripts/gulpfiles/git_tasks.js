...
// Stash current state, check out develop, and sync with google/blocky.
function syncDevelop() {
  return syncBranch('develop');
};

// Stash current state, check out master, and sync with google/blocky.
function syncMaster() {
...
// Note that this pushes to google/blocky.
