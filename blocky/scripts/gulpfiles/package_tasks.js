...
/**
 * This task wraps scripts/package/blocky.js into a UMD module.
 * @example import 'blocky/blocky';
 */
function packageBlockly() {
  return gulp.src('scripts/package/blocky.js')
    .pipe(packageUMD('Blockly', [{
        name: 'Blockly',
        amd: './blockly_compressed',
        cjs: './blockly_compressed',
      }]))
    .pipe(gulp.rename('blocky.js'))
    .pipe(gulp.dest(packageDistribution));
};

/**
 * This task wraps scripts/package/blocks.js into a UMD module.
 * @example import 'blocky/blocks';
 */
 ...
 * @example import * as Blockly from 'blocky';
 */
 ...
 * @example import * as Blockly from 'blocky/browser';
 */
 ...
 * @example import * as Blockly from 'blocky/core';
 */
 ...
 * @example import * as Blockly from 'blocky/node';
 */
 ...
 * @example import 'blocky/javascript';
 */
 ...
 * @example import * as En from 'blocky/msg/en';
 */
...
function packageUMDBundle() {
  ...
  return gulp.src(srcs)
    .pipe(gulp.concat('blocky.min.js'))
    .pipe(gulp.dest(`${packageDistribution}`))
};
...
/**
 * This task copies the typings/blocky.d.ts TypeScript definition file into the
 * distribution directory.
